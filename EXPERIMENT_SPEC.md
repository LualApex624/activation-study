...
H1: ReLU converges faster but exhibits higher instability under noisy data.  
H2: Tanh provides more stable training at the cost of slower convergence.  
H3: Activation saturation negatively impacts generalization performance.  
H4: The effect of activation choice is stronger in time series settings than in
i.i.d. data.
